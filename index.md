...
{% for post in site.posts %}
  <div itemscope itemtype="http://schema.org/BlogPosting">
    <a itemprop="url" href="{{ site.url }}{{ post.url }}"><span itemprop="name" itemprop="headline">{{ post.title }}</span></a>
    ...
    {{ post.excerpt }}
    <span itemprop="author" itemprop="publisher" itemscope itemid="{{ site.url }}" class="hidden">{{ post.author }}</span>
  </div>
{% endfor %}
</div>
